...
app.run(function($http){
	$http.defaults.headers.common.Authorization ="eyJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MzQ0NTUxMDIsInVzZXJuYW1lIjoiYWRtaW4ifQ.FcWIoZbyKAfGtDVPFrD9Tt5HPSSG6onuEdqx5TOHHdI";
...
app.controller("EmployeeController", function($scope, $http){
	...
	//HTTP DELETE methods for delete employee by Id
	...
	//Private Method
	//HTTP GET method for get all employees collection
	//Call: http://localhost:8080/rest/employees
